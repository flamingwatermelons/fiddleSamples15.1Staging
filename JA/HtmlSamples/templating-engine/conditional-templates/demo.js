...
$ ${UnitPrice} 
        ...
        <img width='10' height='15' src= 'http://jp.staging.igniteui.local/15-1/images/samples/templating-engine/colTemplateWithConditionalCell/arrowUp.gif' />
        {{else}}
        <img width='10' height='15' src= 'http://jp.staging.igniteui.local/15-1/images/samples/templating-engine/colTemplateWithConditionalCell/arrowDown.gif' />
        {{/if}}
