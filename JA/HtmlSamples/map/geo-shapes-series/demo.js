         ...
         $(function () {
            ...
            $("#map").igMap({
                ...
                series: [{
                    ...
                    shapeDataSource: 'http://jp.staging.igniteui.local/15-1/data-files/shapes/world_countries_reg.shp',
                    databaseSource: 'http://jp.staging.igniteui.local/15-1/data-files/shapes/world_countries_reg.dbf',
                    opacity: 0.8,
                    outlineThickness: 1,
                    showTooltip: true,
