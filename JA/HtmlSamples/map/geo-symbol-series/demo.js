$(function () {
            ...
            var shapeDataSource = new $.ig.ShapeDataSource({
                shapefileSource: "http://jp.staging.igniteui.local/15-1/data-files/shapes/world_cities.shp",
                databaseSource: "http://jp.staging.igniteui.local/15-1/data-files/shapes/world_cities.dbf",
